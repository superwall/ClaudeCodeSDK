...
public class ChatViewModel {
              ...
              case .assistant(let message):
                ...
                for content in message.message.content {
                  ...
                  case .serverToolUse(let serverToolUse):
                    fatalError()
                   // let serverToolName = "SERVER TOOL: Using \(serverToolUse.name)"
                   // self.addToolUseMessage(toolName: serverToolName, content: serverToolUse.input)
  ...
  private func addToolResultMessage(content: ToolResultContent, isError: Bool) {
